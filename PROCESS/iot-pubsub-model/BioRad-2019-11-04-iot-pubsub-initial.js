...
exports.handler = async (event) => {
    ...
    if (topicBuilder.length > 4) {
        instrument = topicBuilder[4]; // index of instrument is now at 4
        // topicBuilder = topicBuilder.slice(0, 3); // No Need to Slice
